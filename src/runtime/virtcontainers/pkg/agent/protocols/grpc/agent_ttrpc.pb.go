...
type AgentServiceService interface {
	...
	RestoreContainer(context.Context, *RestoreContainerRequest) (*emptypb.Empty, error)
...
func RegisterAgentServiceService(srv *ttrpc.Server, svc AgentServiceService) {
	srv.RegisterService("grpc.AgentService", &ttrpc.ServiceDesc{
		Methods: map[string]ttrpc.Method{
			...
			"RestoreContainer": func(ctx context.Context, unmarshal func(interface{}) error) (interface{}, error) {
				var req RestoreContainerRequest
				if err := unmarshal(&req); err != nil {
					return nil, err
				}
				return svc.RestoreContainer(ctx, &req)
			},
...
func (c *agentserviceClient) RestoreContainer(ctx context.Context, req *RestoreContainerRequest) (*emptypb.Empty, error) {
	var resp emptypb.Empty
	if err := c.client.Call(ctx, "grpc.AgentService", "RestoreContainer", req, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
